 ...
 * 
 *         Place where green dead players come to live.
 *
 */
public class GreenRespawnPoint extends NoPlayer {
	...
	public GreenRespawnPoint(int id, int dependentId, long duration,
